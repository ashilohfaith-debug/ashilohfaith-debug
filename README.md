...
| InnSight | An AI-powered prototype for short-term rental and booking that helps travelers find personalised stays using intelligent recommendations. | React, TypeScript, Tailwind CSS, Google Maps API, Gemini AI | Coming Soon | [View](https://github.com/ashilohfaith-debug/InnSight) |
| ReWorth |	An AI-powered Waste-to-Wealth platform that identifies waste using computer vision and recommends recycling methods to promote a circular economy. | React, TypeScript, Gemini AI, Tailwind CSS | Coming Soon | [View](https://github.com/ashilohfaith-debug/ReWorth) |
| Ochre |	A collaborative workspace where real-time coding, AI assistance, and version history exist together. | React, Monaco Editor, Node.js, WebSockets, Yjs (CRDT), PostgreSQL | Coming Soon | [View](https://github.com/ashilohfaith-debug/Ochre) |
